...
var createShadowDirigeable = function() {
    ...
    var shadow = osgDB.parseSceneGraph(getShadowDirigeable());
    shadow.getOrCreateStateSet().setAttributeAndMode(getShader());
...
var createZepplin = function() {
    var getShader = function() {
        ...
        var fragmentshader = [
            ...
            "vec4 baseColor = vec4(vec3(tex.w*tex.r),1.0);",
...
//            "gl_FragColor = vec4(cameraPosition[0], cameraPosition[1], cameraPosition[2], 1.0);",
    ...
    var root = osgDB.parseSceneGraph(getZepplin());
    var zepplinModelFinder = new FindNodeVisitor("ID25");
    root.accept(zepplinModelFinder);
    var grp = zepplinModelFinder.found[0];
    ...
    var mainpartFinder = new FindNodeVisitor("ID100");
    grp.accept(mainpartFinder);
    var mainpartStateSet = mainpartFinder.found[0].getOrCreateStateSet();
    ...
    var cokpitFinder = new FindNodeVisitor("ID82");
    grp.accept(cokpitFinder);
    var lightCookpit = new osg.Light();
    lightCookpit.setDiffuse([0.8,0.8,0.8,0.2]);
    lightCookpit.setAmbient([0,0,0,0.2]);
...
//    grp.getOrCreateStateSet().setAttributeAndMode(new osg.BlendFunc('ONE','ONE_MINUS_SRC_ALPHA'));
    ...
    var shadowFinder = new FindNodeVisitor("ID127");
